...
<html>
	<head>
        ...
        <title>节点编辑 - 组织机构字典 - 书角 SHUJIAO</title>
        <link href="../css/mgrpublic.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript" src="js/orgedit.js"></script>
    </head>
    ...
    <body>		
		...
		<div class="card">
			<div class="card-block">
				<form id="form-emp-edit" action="../../DctCommon.do?act=edit&dct=org" method="post">
					<legend>节点编辑 - 组织机构字典</legend>
					...
					<div class="form-group row">
						<label for="orgid" class="col-sm-2 form-control-label">节点编号</label>
						<div class="col-sm-10">
							<span id="orgid">无</span>
							<input type="hidden" name="orgid" id="orgid-hidden" />
						</div>
					</div>
					<div class="form-group row">
						<label for="orgname" class="col-sm-2 form-control-label">节点名称</label>
						<div class="col-sm-10">
							<input type="text" id="orgname" name="orgname" class="form-control" placeholder="节点名称" 
	                    		data-container="body" data-toggle="popover" data-placement="right" data-content="" />
						</div>
					</div>
					<div class="form-group row">
						<label for="orgparent" class="col-sm-2 form-control-label">上级节点名称</label>
						<div class="col-sm-10">
							<span id="orgparent">无</span>
						</div>
					</div>
					<div class="form-group row">
						<label for="orgnote" class="col-sm-2 form-control-label">备注</label>
						<div class="col-sm-10">
							<textarea id="orgnote" name="orgnote" class="form-control" placeholder="备注"></textarea>
						</div>
					</div>
