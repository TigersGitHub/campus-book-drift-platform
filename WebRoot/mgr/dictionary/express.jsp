	...
	<head>
        ...
        <script type="text/javascript">
        	function editload(obj) {
	    		...
	    		$.ajax({
	    			url: "../../DctCommon.do",
	    			data: "act=editload&dct=exp&expid=" + id,
	    			type: "post",
	    			success: function (rel) {
	    				var data = eval(rel);
	    				$("#eexpid").val(data[0].EXP_ID);
	    				$("#eexpname").val(data[0].EXP_NAME);
	    				$("#elinkman").val(data[0].EXP_LINKMAN);
	    				$("#etel").val(data[0].EXP_TEL);
	    				$("#enote").val(data[0].EXP_NOTE);
	    			}
	    		});
        	}        
        </script>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">编辑快递厂商</h4>
					</div>
					<div class="modal-body">
						<form id="form-dctedit" class="form-inline" action="../../DctCommon.do?act=edit&dct=exp" method="post">
							<input type="hidden" id="eexpid" name="eexpid" />
							<label for="eexpname">厂商名称</label>
							<input id="eexpname" name="eexpname" type="text" class="form-control" placeholder="厂商名称"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">新增快递厂商</h4>
					</div>
					<div class="modal-body">
						<form id="form-dctadd" class="form-inline" action="../../DctCommon.do?act=add&dct=exp" method="post">
							<label for="expid">厂商标识</label>
							<input id="expid" name="expid" type="text" class="form-control" placeholder="厂商标识"
								data-container="body" data-toggle="popover" data-placement="top" />
							<label for="expname">厂商名称</label>
							<input id="expname" name="expname" type="text" class="form-control" placeholder="厂商名称"
								data-container="body" data-toggle="popover" data-placement="top" />
