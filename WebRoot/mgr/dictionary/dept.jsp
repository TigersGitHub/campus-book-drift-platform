			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="form-dctadd" class="form-inline" action="../../DctCommon.do?act=add&dct=dept" method="post">
							...
							<select id="level" name="level" class="form-control" 
                    			...
                    			<option value="a">院校</option>
                    			<option value="b">院系</option>
                    			<option value="c">专业</option>
                    		</select>
							...
							<label for="deptid">节点编号</label>
							<input id="deptid" name="deptid" type="text" class="form-control" placeholder="节点编号" readonly="readonly" />
							<label for="deptname">节点名称</label>
							<input id="deptname" name="deptname" type="text" class="form-control" placeholder="节点名称" readonly="readonly" />
							<label for="deptadr">　　地址</label>
							<input id="deptadr" name="deptadr" type="text" class="form-control" placeholder="地址" readonly="readonly" />
