    ...
    <body>
		<div class="card list-tool">
			<div class="card-block">
				<form id="form-dctadd" class="form-inline" action="../../DctCommon.do?act=add&dct=format" method="post">
					<label for="fmtname">&nbsp;名称&nbsp;</label>
					<input id="fmtname" name="fmtname" type="text" class="form-control" placeholder="节点名称" />
