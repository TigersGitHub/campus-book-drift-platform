...
<html>
	<head>
        ...
        <title>节点编辑 - 图书语种字典 - 书角 SHUJIAO</title>
        <link href="../css/mgrpublic.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript" src="js/langedit.js"></script>
    </head>
    ...
    <body>		
		...
		<div class="card">
			<div class="card-block">
				<form id="form-emp-edit" action="../../DctCommon.do?act=edit&dct=lang" method="post">
					<legend>节点编辑 - 图书语种字典</legend>
					<span class="pull-right">
						<a href="lang.jsp" class="btn btn-secondary">返回</a>	
					...
					<div class="form-group row">
						<label for="langid" class="col-sm-2 form-control-label">节点编号</label>
						<div class="col-sm-10">
							<span id="langid">无</span>
							<input type="hidden" name="langid" id="langid-hidden" />
						</div>
					</div>
					<div class="form-group row">
						<label for="langname" class="col-sm-2 form-control-label">节点名称</label>
						<div class="col-sm-10">
							<input type="text" id="langname" name="langname" class="form-control" placeholder="节点名称" 
	                    		data-container="body" data-toggle="popover" data-placement="right" data-content="" />
						</div>
					</div>
					<div class="form-group row">
						<label for="langnote" class="col-sm-2 form-control-label">备注</label>
						<div class="col-sm-10">
							<textarea id="langnote" name="langnote" class="form-control" placeholder="备注"></textarea>
						</div>
					</div>
