        ...
        <div class="container" id="container-index">
        	<aside class="article-aside">
        		...
        		<ul id="about-list">
        			...
        			<li><a class="active" href="agreement.jsp">服务协议</a></li>
        	...
        	<article class="article">
        		<header class="article-header">
        			<div class="article-title">服务协议</div>
        			<div class="article-title-en">/User Agreement</div>
        		</header>
        		
        		<section>
        			<pre id="about-agreement"></pre>
        		</section>
