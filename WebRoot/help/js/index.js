$(function () {
	...
	function loadList() {
		$.ajax({
	        url: "../LoadInfo.do",
	        data: "act=helplist&type=" + $("#article-type").val() + "&page=" + currpage,
	        type: "POST",
	        success: function (rel) {
	        	...
	        	for (var i = 0; i < data.length; i++) {
	        		...
	        		str += "<a href='../LoadInfo.do?act=helpjump&no=" + data[i].HELP_ID + "'>" 
	        				+ data[i].HELP_TITLE + "</a><span>[" + data[i].ADDTIME + "]</span></li>";
	        		list.append(str);
	        	}
	        }
		});
	...
	function loadPageControl() {
		$.ajax({
	        url: "../LoadInfo.do",
	        data: "act=helptotalpage&type=" + $("#article-type").val(),
	        type: "POST",
	        success: function (rel) {
	        	//加载页码
	        	var data = eval(rel);
